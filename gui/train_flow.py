...
class TrainFlow:
    ...
    def start(self):
        ...
        choose_txt_button = tk.Button(self.display, text="Choose txt file", command=self.choose_txt_file)
        ...
        self.progress_bar = ttk.Progressbar(self.display, variable=self.progress_var, orient='horizontal',
    ...
    def train_meter(self):
        ...
        gs = GetPasswordStatistic(txt_path, db_path)
